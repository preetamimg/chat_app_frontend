...
const FriendRequestOffcanvas = () => {
  ...
  return (
    <>
      <button onClick={()=>setShowFriendRequest(true)} className='relative size-11 rounded-lg border border-[#D0D5DD] flex items-center justify-center text-[#667085] font-semibold cursor-pointer'>
        <UserPlus size={20} />
      ...
      <div className={`z-50 fixed bg-white shadow w-[30rem] h-dvh top-0 right-0 overflow-hidden flex flex-col transition-all duration-500 ${showFriendRequest ? '' : "translate-x-full"}`}>
